...
<form id="pagerForm" method="post" action="/campus.do?tag=toQuery">
...
<div class="pageHeader">
	<form rel="pagerForm" method="post" action="/campus.do?tag=toQuery" onsubmit="return dwzSearch(this, 'dialog');">
	<input type="hidden" name="rel" value="${rel}"/>
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>校区名称:</label>
				<input class="textInput" name="campusName" value="" type="text">
			</li>
		</ul>
		<div class="subBar">
			<ul>
...
<div class="pageContent">
	<table class="table" layoutH="118" targetType="dialog" width="100%">
		<thead>
			<tr>
				<th orderfield="campusName">校区名称</th>
				<th width="80">查找带回</th>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${PageUtil.dataSet}" var="campus">
			<tr>
				<td>${campus.campusName}</td>
				<td>
					<a class="btnSelect" href="javascript:$.bringBack({campusId:'${campus.campusId}', campusName:'${campus.campusName}'})" title="查找带回">选择</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
